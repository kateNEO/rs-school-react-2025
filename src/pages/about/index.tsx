function About() {
  return (
    <div className="text-inherit text-shadow:inherit">
      <h2 className="text-2xl text-center">ABOUT</h2>
      <p className="text-ml px-5 font-light tracking-wide text-justify mt-10">
      ...
      <p className="text-ml px-5 font-extralight tracking-wide text-justify">
